...
import { AppointmentScheduleStep } from "@/components/forms/AppointmentScheduleStep";
...
import {
  type DbChamber,
  mapChamberIdToDbId,
} from "@/lib/appointment-chamber-map";
import {
  ...
  if (submitted) {
    return (
      <div className="min-h-100 flex flex-col items-center justify-center space-y-8 text-center p-8">
        <div className="w-24 h-24 rounded-full bg-brand-primary/10 flex items-center justify-center animate-scale-in">
          <svg
            width="44"
            height="44"
            viewBox="0 0 24 24"
        ...
        <div className="flex-1">
            ...
            <div className="space-y-6 flex-1 flex flex-col justify-center animate-fade-in">
              ...
              <div className="space-y-1.5 relative">
                ...
                <div className="relative">
                  ...
                  {dropdownOpen && (
                    <div className="absolute left-0 right-0 z-50 top-full mt-1 rounded-xl border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark shadow-2xl shadow-brand-primary/10 overflow-hidden animate-fade-in">
              ...
              {selectedChamber && (
                <div className="rounded-2xl border border-brand-primary/20 bg-brand-primary/3 dark:bg-brand-primary/6 p-5 space-y-4 text-left animate-fade-in">
          ...
          {step === 2 && (
            <AppointmentScheduleStep
              ...
              registerPreferredDate={() => register("preferredDate")}
            />
          )}
